...
from http.server import BaseHTTPRequestHandler, HTTPServer
from views import get_all_animals, get_single_animal, create_animal, get_animals_by_location, get_animals_by_status, delete_animal, update_animal, get_all_locations, get_single_location, create_location, delete_location, update_location, get_all_employees, get_single_employee, get_employees_by_location, create_employee, delete_employee, update_employee, get_all_customers, get_single_customer, get_customer_by_email, create_customer, delete_customer, update_customer
